        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <span class="fw-bold fs-4">DebateSkills</span>
                    </div>
                    <p class="text-secondary">Empowering debaters with the skills, knowledge, and confidence to excel in any debate format.</p>
                ...
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    <h5 class="fs-6 fw-bold mb-3">Product</h5>
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Testimonials</a></li>
                        <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">FAQ</a></li>
                    </ul>
                </div>
                
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    <h5 class="fs-6 fw-bold mb-3">Resources</h5>
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Community</a></li>
                        <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Events</a></li>
                    </ul>
                </div>
                
                <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                    <h5 class="fs-6 fw-bold mb-3">Company</h5>
                    <ul class="list-unstyled">
            ...
            <div class="row border-top border-secondary pt-4 mt-4">
                <div class="col-md-6 mb-3 mb-md-0">
                    <p class="text-secondary mb-0">&copy; <?php echo date('Y'); ?> DebateSkills. All rights reserved.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="text-secondary mb-0">Made with ❤️ for debaters worldwide</p>
                </div>
            </div>
        </div>
    </footer>
